...
def add_ext_eval_args(parser: ArgumentParser):
    ...
    parser.add_argument('--GROUNDING_DINO_CONFIG_PATH',
                        default='/home/kaan/Projects/object_manupilation/track_anything_deva/Tracking-Anything-with-DEVA/saves/GroundingDINO_SwinT_OGC.py')

    parser.add_argument('--GROUNDING_DINO_CHECKPOINT_PATH',
                        default='/home/kaan/Projects/object_manupilation/track_anything_deva/Tracking-Anything-with-DEVA/saves/groundingdino_swint_ogc.pth')
    ...
    parser.add_argument('--SAM_ENCODER_VERSION', default='vit_h') # vit_h
    parser.add_argument('--SAM_CHECKPOINT_PATH', default='/home/kaan/Projects/object_manupilation/track_anything_deva/Tracking-Anything-with-DEVA/saves/sam_vit_h_4b8939.pth')

    # Mobile SAM
    parser.add_argument('--MOBILE_SAM_CHECKPOINT_PATH', default='/home/kaan/Projects/object_manupilation/track_anything_deva/Tracking-Anything-with-DEVA/saves/mobile_sam.pt')
